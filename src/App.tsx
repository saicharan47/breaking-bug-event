...
function Router() { return <RoutedErrorBoundary><Switch><Route path="/" component={ParticipantPage} /><Route path="/admin"><AdminAuthGate><AdminPage /></AdminAuthGate></Route><Route component={NotFound} /></Switch></RoutedErrorBoundary>; }
