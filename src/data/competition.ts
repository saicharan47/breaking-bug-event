...
export const chambers: Chamber[] = [
  ...
  { id: 3, name: 'Ownership', subtitle: 'Confirm control', briefing: 'A recovery action is waiting. Verify that the actor and resource match before proceeding.', options: [{ id: 'A', label: 'Verify authenticated ownership' }, { id: 'B', label: 'Use the oldest session' }, { id: 'C', label: 'Skip authorization' }, { id: 'D', label: 'Broadcast the token' }], answer: 'A' },
  { id: 4, name: 'Safe Write', subtitle: 'Change one thing', briefing: 'The state is almost restored. Choose the smallest controlled mutation.', options: [{ id: 'A', label: 'Apply a validated atomic update' }, { id: 'B', label: 'Overwrite the whole database' }, { id: 'C', label: 'Disable validation' }, { id: 'D', label: 'Retry without a limit' }], answer: 'A' },
  { id: 5, name: 'Recovery Window', subtitle: 'Respect the clock', briefing: 'A delayed worker reconnects during recovery. Decide what timing signal should win.', options: [{ id: 'A', label: 'Use the authoritative server state and timestamp' }, { id: 'B', label: 'Trust the stale local countdown' }, { id: 'C', label: 'Restart the timer on refresh' }, { id: 'D', label: 'Ignore the deadline' }], answer: 'A' },
  { id: 6, name: 'Integrity Check', subtitle: 'Validate the result', briefing: 'The recovery score is being finalized. Confirm the result from trusted recorded answers.', options: [{ id: 'A', label: 'Recompute from stored answers and private keys' }, { id: 'B', label: 'Accept the browser score' }, { id: 'C', label: 'Let the team edit the score' }, { id: 'D', label: 'Skip validation' }], answer: 'A' },
  { id: 7, name: 'Last Gate', subtitle: 'Hold the boundary', briefing: 'A team asks for recovery access. Which signal should decide qualification?', options: [{ id: 'A', label: 'Organizer-computed qualification' }, { id: 'B', label: 'A client-side flag' }, { id: 'C', label: 'A hidden form field' }, { id: 'D', label: 'A screenshot' }], answer: 'A' },
  { id: 8, name: 'Restore', subtitle: 'Return safely', briefing: 'The system is stable. Complete the final transition only after every prior gate is verified.', options: [{ id: 'A', label: 'Commit the verified recovery state' }, { id: 'B', label: 'Delete the audit trail' }, { id: 'C', label: 'Disable access controls' }, { id: 'D', label: 'Reset all credentials in the browser' }], answer: 'A' },
];
