...
export function AdminAuthGate({ children }: { children: ReactNode }) {
  ...
  useEffect(() => watchFirebaseAuth((next) => { setUser(next?.email?.toLowerCase() === ORGANIZER_EMAIL ? next : null); setReady(true); }), []);
